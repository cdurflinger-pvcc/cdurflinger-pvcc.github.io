...
# Prog Purpose: This program demonstates how to manipulate a list, including:
#   finding number of items in the list, sorting the list, adding/removing items,
#   coping a list of items into another list, and changing the data in the list.
...
def main():
    ...
    print ("\nNote: Position number in a list begins with 0, not with 1")
    print ("Pop a dog off from position 3 (wjicj is the 4th dog) in the list:")
    print (dogs)
